...
export const FormItem: FC<FormItemProps> = (props) => {
  const { label, children, name, valuePropName, trigger, getValueFromEvent, rules, validateTrigger } =
  ...
  const rowClass = classNames('cola-row', {
    'cola-row-no-label': !label,
  })
  useEffect(() => {
  ...
  const labelClass = classNames({
    'cola-form-item-required': isRequired,
  })
  const itemClass = classNames('cola-form-item-control', {
    'cola-form-item-has-error': hasError,
  })
  ...
  return (
    <div className={rowClass}>
      {label && (
        <div className="cola-form-item-label">
          <label title={label} className={labelClass}>
            {label}
          </label>
        </div>
      )}
      <div className="cola-form-item">
        <div className={itemClass}>{returnChildNode}</div>
        {hasError && (
          <div className="cola-form-item-explain">
